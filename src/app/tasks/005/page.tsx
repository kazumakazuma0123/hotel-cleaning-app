...
export default function Room005Page() {
    ...
    const handleChangeStatus = () => {
        ...
        setTimeout(() => {
            updateRoomStatus("005", "before-cleaning");
            router.push("/");
        }, 1500);
    };
                ...
                {showSuccess && (
                    <div className="fixed inset-0 z-[100] bg-black/40 backdrop-blur-sm flex items-center justify-center px-6 transition-opacity">
                        <div className="bg-white rounded-[32px] p-8 w-full max-w-[320px] text-center shadow-2xl">
                            ...
                            <h3 className="text-xl font-bold text-black mb-3 tracking-tight">更新完了</h3>
                            <p className="text-sm font-medium text-gray-500 leading-relaxed">
                                ステータスを「清掃前」に<br />変更しました
                            </p>
                        </div>
                    </div>
                )}
