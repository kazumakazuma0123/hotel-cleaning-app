...
const SLACK_X_POSTER_CHANNEL_ID = process.env.SLACK_X_POSTER_CHANNEL_ID || "C0B1NUXB77D";
const SLACK_THREADS_POSTER_CHANNEL_ID = process.env.SLACK_THREADS_POSTER_CHANNEL_ID || "C0B09GHBKU6";
const ALLOWED_CHANNELS = new Set([
  SLACK_CHANNEL_ID,
  SLACK_HOTEL_CHANNEL_ID,
  SLACK_X_POSTER_CHANNEL_ID,
  SLACK_THREADS_POSTER_CHANNEL_ID,
]);
